...
Password required for letterhead access (configure via LETTERHEAD_PASSWORD environment variable)
    ...
    promptForAdvancedOptions() {
        ...
        // For PPT formats, skip margin configuration
        if (this.options.format.startsWith('PPT_')) {
            console.log('ℹ️  PPT formats use zero margins automatically');
            ...
            console.log('✅ Advanced options configured for PPT');
            return;
        }
